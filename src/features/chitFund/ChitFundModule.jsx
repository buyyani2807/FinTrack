...
function ChitMemberDetails({ token, scheme, enrollment, cycles, bids, installments = [], back, onPortalChange }) {
...
function FixedChitMemberDetails({ token, scheme, enrollment, lift, payments, back, recordPayment, deletePayment, onPortalChange }) {
