...
function ChitReceiptCell({ source, paymentRow, memberName, memberPhone, scheme, orgSettings, workspace, token, onLogAction }) {
...
function PredefinedChitMemberDetails({ token, scheme, enrollment, item, payments, back, recordPayment, deletePayment, onPortalChange, onDeleted, orgSettings = {}, workspace = {}, onLogReceipt }) {
  const portalId = enrollmentPortalId(enrollment);
...
function PredefinedBidSchemeDetails({ token, scheme, back, onSchemeDeleted, orgSettings = {}, workspace = {}, onReceipt, onLogReceipt }) {
