...
function ChitDeletePaymentButton({ title, body, confirmLabel = "Delete payment", onConfirm }) {
...
function ChitActivateSchemeModal({ scheme, memberCount, busy, error, onCancel, onConfirm }) {
  return <Modal>
